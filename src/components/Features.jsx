...
const Features = () => {
  return (
    ...
    <div className="mt-80 overflow-x-clip grid grid-cols-1 sm:grid-cols-2 mb-8 gap-10">
      ...
      <div className="flex flex-col items-start -mt-20 ml-40">
    ...
    <div className="mt-80 overflow-x-clip grid grid-cols-1 sm:grid-cols-2 mb-8 gap-10">
      <div className="flex flex-col items-start j -mt-28 ml-32">
        ...
        <div className='flex gap-2 mt-4'>
          <div className='flex flex-col justify-center items-start gap-1'>
            <div className='flex gap-2 justify-center items-center'>
              ...
              <h4 className='text-sm font-bold capitalize'>Best Performance</h4>
            </div>
        ...
        <button className='bg-gradient-to-r from-secondaryDark to-secondary text-white text-sm font-bold capitalize px-6 py-3 rounded-full mt-16'>Get the App</button>
        <small className='text-[9px] text-gray-500 mt-1'>*A complete about-face its core economy Amsterdams</small>
      </div>
