  ...
  return (
    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="flex flex-col justify-center items-center space-y-4 sm:mt-12 mt-10">
          <h1 className="sm:text-7xl text-5xl font-bold w-8/12 leading-[60px] sm:text-center sm:ml-0 ml-16">
