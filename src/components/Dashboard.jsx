...
const Dashboard = () => {
  ...
  return (
    <>
      <div className="bg-[#F0F3F8] sm:h-[33rem] xs:h-40 h-26 border-t border-r border-[#F0F3F8]">
        <div className="ml-32 mt-4">
          <div className="flex sm:flex-row flex-col gap-40 justify-start items-center">
            ...
            <div className="relative flex justify-start items-center gap-4">
              <input
                ...
                className="border bg-gray-200 rounded-full w-40 px-7 py-1 text-xs text-gray-700 focus:ring-transparent focus:outline-none
            "
              />
          ...
          <div className="mt-6  flex-col bg-white p-2 w-8/12 rounded-lg sm:flex hidden">
            <h3 className="text-black font-bold tracking-wide mb-4 text-sm">
              Fitness Activity
            </h3>
          ...
          <div className="mt-8 flex flex-col w-7/12">
            <div className="flex justify-between items-center capitalize mb-4">
              <h3 className="text-black font-bold tracking-wide text-sm">
                recommended
              </h3>
